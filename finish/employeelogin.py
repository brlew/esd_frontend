...
app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('dbURL') or 'mysql+mysqlconnector://root@localhost:3306/g1t6_employee'
...
ROLE_CHOICES = [ ('2', 'Doctor'), ('3', 'Pharmacist')]
...
def load_user(user_id):
    return DoctorUser.query.get(int(user_id)) or PharmacistUser.query.get(int(user_id))
