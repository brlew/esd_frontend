...
# TO RUN SERVICE
# docker build -t borenlew/doctor:g1t6_v2 ./
# docker run -p 5200:5000 -e dbURL=mysql+mysqlconnector://root@host.docker.internal:3306/g1t6_doctor borenlew/doctor:g1t6_v2
